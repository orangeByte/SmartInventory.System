namespace SmartInventory.Client
{
	partial class FluentDesignForm1
	{
		...
		private void InitializeComponent()
		{
			...
			fluentDesignFormContainer1.Size = new Size(779, 512);
			...
			accordionControl1.Size = new Size(269, 512);
			accordionControl1.TabIndex = 1;
			accordionControl1.ViewType = DevExpress.XtraBars.Navigation.AccordionControlViewType.HamburgerMenu;
			// 
			// accordionControlElement1
			// 
			accordionControlElement1.Elements.AddRange(new DevExpress.XtraBars.Navigation.AccordionControlElement[] { accordionControlElement4, accordionControlElement7 });
			...
			fluentDesignFormControl1.Size = new Size(1048, 37);
			...
			barManager1.Items.AddRange(new DevExpress.XtraBars.BarItem[] { barStaticItem1, barStaticItem2, barStaticItem3, barStaticItem4 });
			...
			bar3.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, barStaticItem1, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph), new DevExpress.XtraBars.LinkPersistInfo(barStaticItem2), new DevExpress.XtraBars.LinkPersistInfo(barStaticItem3), new DevExpress.XtraBars.LinkPersistInfo(barStaticItem4) });
			...
			barStaticItem1.ImageOptions.LargeImage = (Image)resources.GetObject("barStaticItem1.ImageOptions.LargeImage");
			...
			barStaticItem2.Id = 1;
			barStaticItem2.ImageOptions.Image = (Image)resources.GetObject("barStaticItem2.ImageOptions.Image");
			barStaticItem2.ImageOptions.LargeImage = (Image)resources.GetObject("barStaticItem2.ImageOptions.LargeImage");
			...
			barStaticItem3.Id = 2;
			barStaticItem3.ImageOptions.Image = (Image)resources.GetObject("barStaticItem3.ImageOptions.Image");
			barStaticItem3.ImageOptions.LargeImage = (Image)resources.GetObject("barStaticItem3.ImageOptions.LargeImage");
			...
			barStaticItem4.Id = 3;
			barStaticItem4.ImageOptions.Image = (Image)resources.GetObject("barStaticItem4.ImageOptions.Image");
			barStaticItem4.ImageOptions.LargeImage = (Image)resources.GetObject("barStaticItem4.ImageOptions.LargeImage");
			...
			barDockControlTop.Size = new Size(1048, 40);
			// 
			...
			barDockControlBottom.Size = new Size(1048, 32);
			// 
			// barDockControlLeft
			// 
			...
			barDockControlLeft.Size = new Size(0, 512);
			// 
			// barDockControlRight
			// 
			barDockControlRight.CausesValidation = false;
			barDockControlRight.Dock = DockStyle.Right;
			barDockControlRight.Location = new Point(1048, 77);
			barDockControlRight.Manager = barManager1;
			barDockControlRight.Size = new Size(0, 512);
			// 
			// timer1
			// 
			timer1.Enabled = true;
			...
			accordionControlElement7.Text = "扫码入库";
			accordionControlElement7.Click += accordionControlElement7_Click;
			// 
			// FluentDesignForm1
			// 
			AutoScaleDimensions = new SizeF(7F, 16F);
			AutoScaleMode = AutoScaleMode.Font;
			ClientSize = new Size(1048, 621);
